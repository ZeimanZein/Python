...
pygame.display.set_caption('Pls give me high rate;))))))')#set up the screen and set up a caption
snake_pos = [80, 30]#initial or start position of snake
snake_speed = 10  #snake moves with this speed 
...
def show_level(): #to display the level of game
 font = pygame.font.SysFont('Georgia', 30)
 Font2 = font.render('Level : ' + str(level), True, 'white') 
 rect2 = Font2.get_rect() 
 screen.blit(Font2, (0,40))#just like displaying text on screen
...
while True: #the game loop covers actual movement handling, the game over conditions, the figure and score functions
 ...
 if snake_pos[0] == foodpos[0] and snake_pos[1] == foodpos[1]: # snake meets the food score is increases and it is time to set up a new food spot
  ...
  if score %50==0:
   level +=1
   snake_speed+=5#when user achieves score of 50,level and speed increases
 ...
 pygame.draw.circle(screen, 'dark red', (foodpos[0], foodpos[1]),7)
